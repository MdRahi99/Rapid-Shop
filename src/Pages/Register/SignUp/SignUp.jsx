    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-sky-50">
            <div className="bg-white p-6 lg:p-16 rounded-tl-3xl rounded-br-3xl shadow-lg w-5/6 lg:w-2/6 mx-auto shadow-sky-300">
                ...
                <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`input input-bordered w-full rounded-0 focus:outline-none input-info rounded-none h-10 ${errors.phoneNumber ? 'border-red-500 focus:border-red-500' : ''
                                }`}
                        />
                        {errors.phoneNumber && (
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`input input-bordered w-full rounded-0 focus:outline-none input-info rounded-none h-10 ${errors.password ? 'border-red-500 focus:border-red-500' : ''
                                }`}
                        />
                        {errors.password && (
                ...
                <h1 className="mt-4">
                    Have an Account? <Link to="/" className="font-bold">Log In</Link>
                </h1>
            </div>
        </div>
    );
