    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-sky-50">
            <div className="bg-white p-16 rounded-tl-3xl rounded-br-3xl shadow-lg w-5/6 lg:w-2/6 mx-auto shadow-sky-300">
                <h2 className="text-xl uppercase text-center font-semibold mb-8 font-Ledger border-b-2 border-sky-300 pb-4">Rapid Shop Register</h2>
                <form className="flex flex-col gap-6">
                    <div>
                        <h1 className="text-lg font-serif mb-2">
                            Full Name
                        </h1>
                        <input type="text" name="name" placeholder="Enter your full name" className="input input-bordered w-full rounded-0 focus:outline-none input-info rounded-none h-10" />
                    </div>
                    <div>
                        <h1 className="text-lg font-serif mb-2">
                            Phone Number
                ...
                <h1 className="mt-4">Have an Account? <Link to='/' className="font-bold">Log In</Link></h1>
            </div>
        </div>
    );
};
